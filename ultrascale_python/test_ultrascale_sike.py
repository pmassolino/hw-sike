...
def test_single_sike_keygen(ultrascale, fp2, base_word_size, extended_word_size, number_of_words, alice_gen_points, bob_gen_points, bob_splits, bob_max_row, bob_max_int_points, ob, ob_bits, sike_message_length, sike_sk, sike_s, debug_mode=False):
    ...
    for j in range(32):
        ultrascale.write_package(start_address_sike_sk+j, test_value_sike_sk_list[j])
    ...
    for j in range(0, len(sike_s), 2):
        ultrascale.write_package(start_address_sike_s+(j//2), sike_s[j+1]*256 + sike_s[j])
    for j in range(len(sike_s), 32, 2):
        ultrascale.write_package(start_address_sike_s+(j//2), 0)
    
    ultrascale.write_package(sike_core_reg_program_counter_address, program_start_address_test_sike_kem_keygen)
    ...
    computed_test_value_o3_list  = ultrascale.read_mac_ram_operand(sike_core_mac_ram_start_address + sike_core_mac_ram_output_function_start_address + 0, number_of_words)
    computed_test_value_o3i_list = ultrascale.read_mac_ram_operand(sike_core_mac_ram_start_address + sike_core_mac_ram_output_function_start_address + 1, number_of_words)
    computed_test_value_o4_list  = ultrascale.read_mac_ram_operand(sike_core_mac_ram_start_address + sike_core_mac_ram_output_function_start_address + 2, number_of_words)
    computed_test_value_o4i_list = ultrascale.read_mac_ram_operand(sike_core_mac_ram_start_address + sike_core_mac_ram_output_function_start_address + 3, number_of_words)
    computed_test_value_o5_list  = ultrascale.read_mac_ram_operand(sike_core_mac_ram_start_address + sike_core_mac_ram_output_function_start_address + 4, number_of_words)
    computed_test_value_o5i_list = ultrascale.read_mac_ram_operand(sike_core_mac_ram_start_address + sike_core_mac_ram_output_function_start_address + 5, number_of_words)
    ...
    start_address_sike_sk = sike_core_base_alu_ram_start_address + sike_core_base_alu_ram_sike_sk_start_address
    for j in range(32):
        computed_test_value_o1_list[j] = ultrascale.read_package(start_address_sike_sk+j)
    
    computed_test_value_o2_list = bytearray(sike_message_length)
    start_address_sike_s = sike_core_base_alu_ram_start_address + sike_core_base_alu_ram_sike_s_start_address
    for j in range(0, len(computed_test_value_o2_list), 2):
        temp_value = ultrascale.read_package(start_address_sike_s+(j//2))
...
def test_sike_keygen(ultrascale, param, number_of_tests, debug_mode=False):
    ...
    for test in fixed_tests:
        ...
        sike_sk = test[1]
        error_computation = test_single_sike_keygen(ultrascale, fp2, base_word_size, extended_word_size, number_of_words, alice_gen_points, bob_gen_points, bob_splits, bob_max_row, bob_max_int_points, ob, ob_bits, sike_message_length, sike_sk, sike_s, debug_mode)
...
def test_all_sike_keygen(ultrascale, sike_fpga_constants, number_of_tests, only_one_parameter=None):
    error_computation = False
    ...
    for param in all_testing_parameters:
        ...
        error_computation = test_sike_keygen(ultrascale, param, number_of_tests, debug_mode=False)
        if(error_computation):
            break

def test_single_sike_encryption(ultrascale, fp2, extended_word_size, number_of_words, alice_gen_points, alice_splits, alice_max_row, alice_max_int_points, bob_gen_points, bob_splits, bob_max_row, bob_max_int_points, oa, ob, oa_bits, ob_bits, sike_message_length, sike_shared_secret_length, sike_sk, sike_s, sike_m, debug_mode=False):
    ...
    ultrascale.write_mac_ram_operand(sike_core_mac_ram_input_function_start_address + 0, true_sike_pk_phiPx_list, number_of_words)
    ultrascale.write_mac_ram_operand(sike_core_mac_ram_input_function_start_address + 1, true_sike_pk_phiPxi_list, number_of_words)
    ultrascale.write_mac_ram_operand(sike_core_mac_ram_input_function_start_address + 2, true_sike_pk_phiQx_list, number_of_words)
    ultrascale.write_mac_ram_operand(sike_core_mac_ram_input_function_start_address + 3, true_sike_pk_phiQxi_list, number_of_words)
    ultrascale.write_mac_ram_operand(sike_core_mac_ram_input_function_start_address + 4, true_sike_pk_phiRx_list, number_of_words)
    ultrascale.write_mac_ram_operand(sike_core_mac_ram_input_function_start_address + 5, true_sike_pk_phiRxi_list, number_of_words)
    ...
    for j in range(0, len(sike_m), 2):
        ultrascale.write_package(start_address_sike_m+(j//2), sike_m[j+1]*256 + sike_m[j])
    for j in range(len(sike_m), 32, 2):
        ultrascale.write_package(start_address_sike_m+(j//2), 0)
    
    ultrascale.write_package(sike_core_reg_program_counter_address, program_start_address_test_sike_kem_enc)
    ...
    computed_test_value_o3_list  = ultrascale.read_mac_ram_operand(sike_core_mac_ram_output_function_start_address + 0, number_of_words)
    computed_test_value_o3i_list = ultrascale.read_mac_ram_operand(sike_core_mac_ram_output_function_start_address + 1, number_of_words)
    computed_test_value_o4_list  = ultrascale.read_mac_ram_operand(sike_core_mac_ram_output_function_start_address + 2, number_of_words)
    computed_test_value_o4i_list = ultrascale.read_mac_ram_operand(sike_core_mac_ram_output_function_start_address + 3, number_of_words)
    computed_test_value_o5_list  = ultrascale.read_mac_ram_operand(sike_core_mac_ram_output_function_start_address + 4, number_of_words)
    ...
    for j in range(0, len(computed_test_value_o1_list), 2):
        temp_value = ultrascale.read_package(start_address_sike_ss+(j//2))
    ...
    for j in range(0, len(computed_test_value_o2_list), 2):
        temp_value = ultrascale.read_package(start_address_sike_c1+(j//2))
        computed_test_value_o2_list[j]   = temp_value & 255;
        computed_test_value_o2_list[j+1] = (temp_value >> 8) & 255;
...
def test_sike_encryption(ultrascale, param, number_of_tests, debug_mode=False):
...
def test_all_sike_encryption(ultrascale, sike_fpga_constants, number_of_tests, only_one_parameter=None):
    error_computation = False
    if(only_one_parameter != None):
        all_testing_parameters = sike_fpga_constants[only_one_parameter:only_one_parameter+1]
    else:
    ...
    for param in all_testing_parameters:
        ...
        error_computation = test_sike_encryption(ultrascale, param, number_of_tests, debug_mode=False)
        if(error_computation):
            break

def test_single_sike_decryption(ultrascale, fp2, base_word_size, extended_word_size, number_of_words, alice_gen_points, alice_splits, alice_max_row, alice_max_int_points, bob_gen_points, bob_splits, bob_max_row, bob_max_int_points, oa, ob, oa_bits, ob_bits, sike_message_length, sike_shared_secret_length, sike_sk, sike_s, sike_m, debug_mode=False):
    ...
    ultrascale.write_mac_ram_operand(sike_core_mac_ram_input_function_start_address + 6, true_sike_c0_phiPx_list, number_of_words)
    ultrascale.write_mac_ram_operand(sike_core_mac_ram_input_function_start_address + 7, true_sike_c0_phiPxi_list, number_of_words)
    ultrascale.write_mac_ram_operand(sike_core_mac_ram_input_function_start_address + 8, true_sike_c0_phiQx_list, number_of_words)
    ultrascale.write_mac_ram_operand(sike_core_mac_ram_input_function_start_address + 9, true_sike_c0_phiQxi_list, number_of_words)
    ultrascale.write_mac_ram_operand(sike_core_mac_ram_input_function_start_address + 10, true_sike_c0_phiRx_list, number_of_words)
    ultrascale.write_mac_ram_operand(sike_core_mac_ram_input_function_start_address + 11, true_sike_c0_phiRxi_list, number_of_words)
    ...
    for j in range(0, len(true_sike_c1), 2):
        ultrascale.write_package(start_address_sike_c1+(j//2), true_sike_c1[j+1]*256 + true_sike_c1[j])
    for j in range(len(true_sike_c1), 32, 2):
        ultrascale.write_package(start_address_sike_c1+(j//2), 0)
    
    ultrascale.write_package(sike_core_reg_program_counter_address, program_start_address_test_sike_kem_dec)
...
def test_sike_decryption(ultrascale, param, number_of_tests, debug_mode=False):
    ...
    for test in fixed_tests:
        ...
        sike_sk = test[1]
        sike_m  = bytearray(test[2])
        error_computation = test_single_sike_decryption(ultrascale, fp2, base_word_size, extended_word_size, number_of_words, alice_gen_points, alice_splits, alice_max_row, alice_max_int_points, bob_gen_points, bob_splits, bob_max_row, bob_max_int_points, oa, ob, oa_bits, ob_bits, sike_message_length, sike_shared_secret_length, sike_sk, sike_s, sike_m, debug_mode=False)
        tests_already_performed += 1
        if(error_computation):
            break
...
def test_all_sike_decryption(ultrascale, sike_fpga_constants, number_of_tests, only_one_parameter=None):
    error_computation = False
    if(only_one_parameter != None):
        all_testing_parameters = sike_fpga_constants[only_one_parameter:only_one_parameter+1]
    else:
    ...
    for param in all_testing_parameters:
        ...
        error_computation = test_sike_decryption(ultrascale, param, number_of_tests, debug_mode=False)
        if(error_computation):
            break

def test_all_sike_functions(ultrascale, version, only_one_parameter=None):
    ...
    if(load_program(ultrascale, tests_prom_folder + "test_sike_sidh_ecc_functions_v" + str(sike_extended_word_size)+ ".dat", sike_base_word_size, 4)):
        ...
        test_all_sike_keygen(ultrascale, sike_fpga_constants, 100, only_one_parameter)
        test_all_sike_encryption(ultrascale, sike_fpga_constants, 100, only_one_parameter)
        test_all_sike_decryption(ultrascale, sike_fpga_constants, 100, only_one_parameter)
    else:
...
test_all_sike_functions(ultrascale, sys.argv[1])
