...
def generate_fpga_constants(prime_oa, prime_ob, sidh_alice_gen_points, sidh_bob_gen_points, sidh_alice_splits, sidh_alice_max_row, sidh_alice_max_int_points, sidh_bob_splits, sidh_bob_max_row, sidh_bob_max_int_points, sike_message_length, sike_shared_secret_length, base_word_size, extended_word_size, number_of_bits_added):
    sike_fpga_constants = [0 for i in range(54)]
    ...
    sike_fpga_constants[9]  = prime_plus_one_number_of_zeroes
    sike_fpga_constants[10] = prime2
    sike_fpga_constants[11] = prime_oa
    sike_fpga_constants[12] = prime_ob
    sike_fpga_constants[13] = oa_mask
    sike_fpga_constants[14] = ob_mask
    sike_fpga_constants[15] = oa_bits
    sike_fpga_constants[16] = ob_bits
    sike_fpga_constants[17] = r_mod_prime
    sike_fpga_constants[18] = r2_mod_prime
    sike_fpga_constants[19] = int(1)
    sike_fpga_constants[20] = int(inv_4_mont)
    
    sike_fpga_constants[21] = sike_core_utils.enter_montgomery_domain(arithmetic_parameters, sidh_alice_gen_points[0])
    sike_fpga_constants[22] = sike_core_utils.enter_montgomery_domain(arithmetic_parameters, sidh_alice_gen_points[1])
    sike_fpga_constants[23] = sike_core_utils.enter_montgomery_domain(arithmetic_parameters, sidh_alice_gen_points[2])
    sike_fpga_constants[24] = sike_core_utils.enter_montgomery_domain(arithmetic_parameters, sidh_alice_gen_points[3])
    sike_fpga_constants[25] = sike_core_utils.enter_montgomery_domain(arithmetic_parameters, sidh_alice_gen_points[4])
    sike_fpga_constants[26] = sike_core_utils.enter_montgomery_domain(arithmetic_parameters, sidh_alice_gen_points[5])
    sike_fpga_constants[27] = sike_core_utils.enter_montgomery_domain(arithmetic_parameters, sidh_bob_gen_points[0])
    sike_fpga_constants[28] = sike_core_utils.enter_montgomery_domain(arithmetic_parameters, sidh_bob_gen_points[1])
    sike_fpga_constants[29] = sike_core_utils.enter_montgomery_domain(arithmetic_parameters, sidh_bob_gen_points[2])
    sike_fpga_constants[30] = sike_core_utils.enter_montgomery_domain(arithmetic_parameters, sidh_bob_gen_points[3])
    sike_fpga_constants[31] = sike_core_utils.enter_montgomery_domain(arithmetic_parameters, sidh_bob_gen_points[4])
    sike_fpga_constants[32] = sike_core_utils.enter_montgomery_domain(arithmetic_parameters, sidh_bob_gen_points[5])
    
    sike_fpga_constants[33] = sidh_alice_splits
    sike_fpga_constants[34] = sidh_alice_max_row
    sike_fpga_constants[35] = sidh_alice_max_int_points
    sike_fpga_constants[36] = sidh_bob_splits
    sike_fpga_constants[37] = sidh_bob_max_row
    sike_fpga_constants[38] = sidh_bob_max_int_points
    sike_fpga_constants[39] = sike_message_length
    sike_fpga_constants[40] = sike_shared_secret_length
    sike_fpga_constants[41] = 224*(1024//extended_word_size)
    
    sike_fpga_constants[42] = sidh_alice_gen_points[0]
    sike_fpga_constants[43] = sidh_alice_gen_points[1]
    sike_fpga_constants[44] = sidh_alice_gen_points[2]
    sike_fpga_constants[45] = sidh_alice_gen_points[3]
    sike_fpga_constants[46] = sidh_alice_gen_points[4]
    sike_fpga_constants[47] = sidh_alice_gen_points[5]
    sike_fpga_constants[48] = sidh_bob_gen_points[0]
    sike_fpga_constants[49] = sidh_bob_gen_points[1]
    sike_fpga_constants[50] = sidh_bob_gen_points[2]
    sike_fpga_constants[51] = sidh_bob_gen_points[3]
    sike_fpga_constants[52] = sidh_bob_gen_points[4]
    sike_fpga_constants[53] = sidh_bob_gen_points[5]
...
def print_fpga_constants(filename_constants, sike_fpga_constants_all_parameters):
    with open(filename_constants, 'w') as file_constants:
        ...
        for sike_fpga_constants in sike_fpga_constants_all_parameters:
            ...
            file_constants.write(str(sike_fpga_constants[53]) + ',\n')
            file_constants.write('],\n')
        file_constants.write(']\n')
