...
def load_VHDL_keygen_alice_fast_test(zedboard, VHDL_memory_file_name, base_word_size, extended_word_size, prime_size_bits, number_of_bits_added, prime, number_of_tests = 0, debug_mode=False):
    ...
    zedboard.write_mac_ram_operand(sidh_core_mac_ram_prime_address, loaded_prime_list, number_of_words)
    zedboard.write_mac_ram_operand(sidh_core_mac_ram_prime_plus_one_address, loaded_prime_plus_one_list, number_of_words)
    zedboard.write_mac_ram_operand(sidh_core_mac_ram_prime_line_address, loaded_prime_line_list, number_of_words)
    zedboard.write_mac_ram_operand(sidh_core_mac_ram_const_r_address, loaded_r_mod_prime_list, number_of_words)
    zedboard.write_mac_ram_operand(sidh_core_mac_ram_const_r2_address, loaded_r2_list, number_of_words)
    zedboard.write_mac_ram_operand(sidh_core_mac_ram_const_1_address, loaded_constant_1_list, number_of_words)
    zedboard.write_mac_ram_operand(sidh_core_mac_ram_inv_4_mont_address, loaded_constant_inv_4_list, number_of_words)
    
    zedboard.write_mac_ram_operand(sidh_core_mac_ram_sidh_xpa_mont_address,  test_value_xpa_mont_list, number_of_words)
    zedboard.write_mac_ram_operand(sidh_core_mac_ram_sidh_xpai_mont_address, test_value_xpai_mont_list, number_of_words)
    zedboard.write_mac_ram_operand(sidh_core_mac_ram_sidh_xqa_mont_address,  test_value_xqa_mont_list, number_of_words)
    zedboard.write_mac_ram_operand(sidh_core_mac_ram_sidh_xqai_mont_address, test_value_xqai_mont_list, number_of_words)
    zedboard.write_mac_ram_operand(sidh_core_mac_ram_sidh_xra_mont_address,  test_value_xra_mont_list, number_of_words)
    zedboard.write_mac_ram_operand(sidh_core_mac_ram_sidh_xrai_mont_address, test_value_xrai_mont_list, number_of_words)
    zedboard.write_mac_ram_operand(sidh_core_mac_ram_sidh_xpb_mont_address,  test_value_xpb_mont_list, number_of_words)
    zedboard.write_mac_ram_operand(sidh_core_mac_ram_sidh_xpbi_mont_address, test_value_xpbi_mont_list, number_of_words)
    zedboard.write_mac_ram_operand(sidh_core_mac_ram_sidh_xqb_mont_address,  test_value_xqb_mont_list, number_of_words)
    zedboard.write_mac_ram_operand(sidh_core_mac_ram_sidh_xqbi_mont_address, test_value_xqbi_mont_list, number_of_words)
    zedboard.write_mac_ram_operand(sidh_core_mac_ram_sidh_xrb_mont_address,  test_value_xrb_mont_list, number_of_words)
    zedboard.write_mac_ram_operand(sidh_core_mac_ram_sidh_xrbi_mont_address, test_value_xrbi_mont_list, number_of_words)
    
    if(enable_loading_verification_of_values):
        value_to_verify = zedboard.read_mac_ram_operand(sidh_core_mac_ram_prime_address, number_of_words)
        ...
        value_to_verify = zedboard.read_mac_ram_operand(sidh_core_mac_ram_prime_plus_one_address, number_of_words)
        ...
        value_to_verify = zedboard.read_mac_ram_operand(sidh_core_mac_ram_prime_line_address, number_of_words)
        ...
        value_to_verify = zedboard.read_mac_ram_operand(sidh_core_mac_ram_const_r_address, number_of_words)
        ...
        value_to_verify = zedboard.read_mac_ram_operand(sidh_core_mac_ram_const_r2_address, number_of_words)
        ...
        value_to_verify = zedboard.read_mac_ram_operand(sidh_core_mac_ram_const_1_address, number_of_words)
        ...
        value_to_verify = zedboard.read_mac_ram_operand(sidh_core_mac_ram_inv_4_mont_address, number_of_words)
        ...
        value_to_verify = zedboard.read_mac_ram_operand(sidh_core_mac_ram_sidh_xpa_mont_address, number_of_words)
        ...
        value_to_verify = zedboard.read_mac_ram_operand(sidh_core_mac_ram_sidh_xpai_mont_address, number_of_words)
        ...
        value_to_verify = zedboard.read_mac_ram_operand(sidh_core_mac_ram_sidh_xqa_mont_address, number_of_words)
        ...
        value_to_verify = zedboard.read_mac_ram_operand(sidh_core_mac_ram_sidh_xqai_mont_address, number_of_words)
        ...
        value_to_verify = zedboard.read_mac_ram_operand(sidh_core_mac_ram_sidh_xra_mont_address, number_of_words)
        ...
        value_to_verify = zedboard.read_mac_ram_operand(sidh_core_mac_ram_sidh_xrai_mont_address, number_of_words)
        ...
        value_to_verify = zedboard.read_mac_ram_operand(sidh_core_mac_ram_sidh_xpb_mont_address, number_of_words)
        ...
        value_to_verify = zedboard.read_mac_ram_operand(sidh_core_mac_ram_sidh_xpbi_mont_address, number_of_words)
        ...
        value_to_verify = zedboard.read_mac_ram_operand(sidh_core_mac_ram_sidh_xqb_mont_address, number_of_words)
        ...
        value_to_verify = zedboard.read_mac_ram_operand(sidh_core_mac_ram_sidh_xqbi_mont_address, number_of_words)
        ...
        value_to_verify = zedboard.read_mac_ram_operand(sidh_core_mac_ram_sidh_xrb_mont_address, number_of_words)
        ...
        value_to_verify = zedboard.read_mac_ram_operand(sidh_core_mac_ram_sidh_xrbi_mont_address, number_of_words)
    ...
    zedboard.write_package(sidh_core_base_alu_ram_start_address + sidh_core_base_alu_ram_oa_bits_address, loaded_oa_bits)
    zedboard.write_package(sidh_core_base_alu_ram_start_address + sidh_core_base_alu_ram_ob_bits_address, loaded_ob_bits)
    zedboard.write_package(sidh_core_base_alu_ram_start_address + sidh_core_base_alu_ram_prime_size_bits_address, loaded_prime_size_bits)
    start_address = sidh_core_base_alu_ram_start_address + sidh_core_base_alu_ram_splits_alice_start_address
    for i in range(302):
        zedboard.write_package(start_address+i, loaded_splits_alice[i])
    zedboard.write_package(sidh_core_base_alu_ram_start_address + sidh_core_base_alu_ram_max_row_alice_address, loaded_max_row_alice)
    start_address = sidh_core_base_alu_ram_start_address + sidh_core_base_alu_ram_splits_bob_start_address
    for i in range(302):
        zedboard.write_package(start_address+i, loaded_splits_bob[i])
    zedboard.write_package(sidh_core_base_alu_ram_start_address + sidh_core_base_alu_ram_max_row_bob_address, loaded_max_row_bob)
    
    if(enable_loading_verification_of_values):
        value_to_verify = zedboard.read_package(sidh_core_base_alu_ram_start_address + sidh_core_base_alu_ram_oa_bits_address)
        ...
        value_to_verify = zedboard.read_package(sidh_core_base_alu_ram_start_address + sidh_core_base_alu_ram_ob_bits_address)
        ...
        value_to_verify = zedboard.read_package(sidh_core_base_alu_ram_start_address + sidh_core_base_alu_ram_prime_size_bits_address)
        if(value_to_verify != loaded_prime_size_bits):
            ...
            print('Input value')
            print(loaded_prime_size_bits)
        value_to_verify = zedboard.read_package(sidh_core_base_alu_ram_start_address + sidh_core_base_alu_ram_max_row_alice_address)
        ...
        value_to_verify = zedboard.read_package(sidh_core_base_alu_ram_start_address + sidh_core_base_alu_ram_max_row_bob_address)
        ...
        for i in range(302):
            read_loaded_splits_alice[i] = zedboard.read_package(start_address_a+i)
            read_loaded_splits_bob[i] = zedboard.read_package(start_address_b+i)
    ...
    while(current_test != (number_of_tests-1)):
        ...
        zedboard.write_mac_ram_operand(sidh_core_mac_ram_input_function_start_address + 0, loaded_sk_list, number_of_words)
        
        if(enable_loading_verification_of_values):
            value_to_verify = zedboard.read_mac_ram_operand(sidh_core_mac_ram_input_function_start_address + 0, number_of_words)
        ...
        zedboard.write_package(sidh_core_reg_operands_size_address, number_of_words - 1)
        zedboard.write_package(sidh_core_reg_prime_line_equal_one_address, 0)
        zedboard.write_package(sidh_core_reg_prime_address_address, 0)
        zedboard.write_package(sidh_core_reg_prime_plus_one_address_address, 1)
        zedboard.write_package(sidh_core_reg_prime_line_address_address, 2)
        zedboard.write_package(sidh_core_reg_initial_stack_address_address, 4*starting_position_stack_sidh_core)
        zedboard.write_package(sidh_core_reg_program_counter_address, program_start_address_test_ketgen_alice)
        ...
        computed_test_value_o1_list = zedboard.read_mac_ram_operand(sidh_core_mac_ram_output_function_start_address + 0, number_of_words)
        computed_test_value_o1i_list = zedboard.read_mac_ram_operand(sidh_core_mac_ram_output_function_start_address + 1, number_of_words)
        computed_test_value_o2_list = zedboard.read_mac_ram_operand(sidh_core_mac_ram_output_function_start_address + 2, number_of_words)
        computed_test_value_o2i_list = zedboard.read_mac_ram_operand(sidh_core_mac_ram_output_function_start_address + 3, number_of_words)
        computed_test_value_o3_list = zedboard.read_mac_ram_operand(sidh_core_mac_ram_output_function_start_address + 4, number_of_words)
        computed_test_value_o3i_list = zedboard.read_mac_ram_operand(sidh_core_mac_ram_output_function_start_address + 5, number_of_words)
...
def load_all_keygen_alice_fast(zedboard, base_word_size, extended_word_size, number_of_bits_added, tests_working_folder):
    ...
    for param in sidh_constants:
        ...
        error_computation = load_VHDL_keygen_alice_fast_test(zedboard, VHDL_memory_file_name, base_word_size, extended_word_size, prime_size_bits, number_of_bits_added, prime)
        if error_computation:
            break;
    
def load_VHDL_shared_secret_alice_fast_test(zedboard, VHDL_memory_file_name, base_word_size, extended_word_size, prime_size_bits, number_of_bits_added, prime, number_of_tests = 0, debug_mode=False):
    VHDL_memory_file = open(VHDL_memory_file_name, 'r')
    VHDL_memory_file.seek(0, 2)
    VHDL_file_size = VHDL_memory_file.tell()
    VHDL_memory_file.seek(0)
    ...
    while(current_test != (number_of_tests-1)):
        ...
        zedboard.write_mac_ram_operand(sidh_core_mac_ram_input_function_start_address + 0, test_value_bob_phiPX_mont_list, number_of_words)
        zedboard.write_mac_ram_operand(sidh_core_mac_ram_input_function_start_address + 1, test_value_bob_phiPXi_mont_list, number_of_words)
        zedboard.write_mac_ram_operand(sidh_core_mac_ram_input_function_start_address + 2, test_value_bob_phiQX_mont_list, number_of_words)
        zedboard.write_mac_ram_operand(sidh_core_mac_ram_input_function_start_address + 3, test_value_bob_phiQXi_mont_list, number_of_words)
        zedboard.write_mac_ram_operand(sidh_core_mac_ram_input_function_start_address + 4, test_value_bob_phiRX_mont_list, number_of_words)
        zedboard.write_mac_ram_operand(sidh_core_mac_ram_input_function_start_address + 5, test_value_bob_phiRXi_mont_list, number_of_words)
        zedboard.write_mac_ram_operand(sidh_core_mac_ram_input_function_start_address + 6, loaded_sk_list, number_of_words)
        ...
        if(enable_loading_verification_of_values):
            ...
            value_to_verify = zedboard.read_mac_ram_operand(sidh_core_mac_ram_input_function_start_address + 1, number_of_words)
            ...
            value_to_verify = zedboard.read_mac_ram_operand(sidh_core_mac_ram_input_function_start_address + 2, number_of_words)
            ...
            value_to_verify = zedboard.read_mac_ram_operand(sidh_core_mac_ram_input_function_start_address + 3, number_of_words)
            ...
            value_to_verify = zedboard.read_mac_ram_operand(sidh_core_mac_ram_input_function_start_address + 4, number_of_words)
            ...
            value_to_verify = zedboard.read_mac_ram_operand(sidh_core_mac_ram_input_function_start_address + 5, number_of_words)
            ...
            value_to_verify = zedboard.read_mac_ram_operand(sidh_core_mac_ram_input_function_start_address + 6, number_of_words)
            if(value_to_verify != loaded_sk_list):
                print("Error in shared secret Alice fast computation : " + str(current_test))
                print('Error loading: Secret key')
                print('Loaded value')
        ...
        zedboard.write_package(sidh_core_reg_prime_line_address_address, 2)
        zedboard.write_package(sidh_core_reg_initial_stack_address_address, 4*starting_position_stack_sidh_core)
        zedboard.write_package(sidh_core_reg_program_counter_address, program_start_address_test_shared_secret_alice)
...
def load_all_shared_secret_alice_fast(zedboard, base_word_size, extended_word_size, number_of_bits_added, tests_working_folder):
    error_computation = False
    for param in sidh_constants:
        ...
        error_computation = load_VHDL_shared_secret_alice_fast_test(zedboard, VHDL_memory_file_name, base_word_size, extended_word_size, prime_size_bits, number_of_bits_added, prime)
        if error_computation:
            break;

def load_VHDL_keygen_bob_fast_test(zedboard, VHDL_memory_file_name, base_word_size, extended_word_size, prime_size_bits, number_of_bits_added, prime, number_of_tests = 0, debug_mode=False):
    VHDL_memory_file = open(VHDL_memory_file_name, 'r')
    VHDL_memory_file.seek(0, 2)
    VHDL_file_size = VHDL_memory_file.tell()
    VHDL_memory_file.seek(0)
    ...
    while(current_test != (number_of_tests-1)):
        ...
        zedboard.write_package(sidh_core_reg_prime_line_address_address, 2)
        zedboard.write_package(sidh_core_reg_initial_stack_address_address, 4*starting_position_stack_sidh_core)
        zedboard.write_package(sidh_core_reg_program_counter_address, program_start_address_test_ketgen_bob)
...
def load_all_keygen_bob_fast(zedboard, base_word_size, extended_word_size, number_of_bits_added, tests_working_folder):
    error_computation = False
    for param in sidh_constants:
        ...
        error_computation = load_VHDL_keygen_bob_fast_test(zedboard, VHDL_memory_file_name, base_word_size, extended_word_size, prime_size_bits, number_of_bits_added, prime)
        if error_computation:
            break;
            
def load_VHDL_shared_secret_bob_fast_test(zedboard, VHDL_memory_file_name, base_word_size, extended_word_size, prime_size_bits, number_of_bits_added, prime, number_of_tests = 0, debug_mode=False):
    VHDL_memory_file = open(VHDL_memory_file_name, 'r')
    VHDL_memory_file.seek(0, 2)
    VHDL_file_size = VHDL_memory_file.tell()
    VHDL_memory_file.seek(0)
    ...
    while(current_test != (number_of_tests-1)):
        ...
        zedboard.write_mac_ram_operand(sidh_core_mac_ram_input_function_start_address + 0, test_value_alice_phiPX_mont_list, number_of_words)
        zedboard.write_mac_ram_operand(sidh_core_mac_ram_input_function_start_address + 1, test_value_alice_phiPXi_mont_list, number_of_words)
        zedboard.write_mac_ram_operand(sidh_core_mac_ram_input_function_start_address + 2, test_value_alice_phiQX_mont_list, number_of_words)
        zedboard.write_mac_ram_operand(sidh_core_mac_ram_input_function_start_address + 3, test_value_alice_phiQXi_mont_list, number_of_words)
        zedboard.write_mac_ram_operand(sidh_core_mac_ram_input_function_start_address + 4, test_value_alice_phiRX_mont_list, number_of_words)
        zedboard.write_mac_ram_operand(sidh_core_mac_ram_input_function_start_address + 5, test_value_alice_phiRXi_mont_list, number_of_words)
        zedboard.write_mac_ram_operand(sidh_core_mac_ram_input_function_start_address + 6, loaded_sk_list, number_of_words)
        ...
        zedboard.write_package(sidh_core_reg_prime_line_address_address, 2)
        zedboard.write_package(sidh_core_reg_initial_stack_address_address, 4*starting_position_stack_sidh_core)
        zedboard.write_package(sidh_core_reg_program_counter_address, program_start_address_test_shared_secret_bob)
...
def load_all_shared_secret_bob_fast(zedboard, base_word_size, extended_word_size, number_of_bits_added, tests_working_folder):
    error_computation = False
    for param in sidh_constants:
        ...
        error_computation = load_VHDL_shared_secret_bob_fast_test(zedboard, VHDL_memory_file_name, base_word_size, extended_word_size, prime_size_bits, number_of_bits_added, prime)
        if error_computation:
            break;
...
def test_all_sidh_functions(zedboard, sidh_extended_word_size):
    ...
    if(load_program(zedboard, tests_prom_folder + "test_sidh_functions_v" + str(sidh_extended_word_size+1)+ ".dat", sidh_base_word_size, 4)):
        print("Program loaded correctly into SIDH core")
        load_all_keygen_alice_fast(zedboard, sidh_base_word_size, sidh_extended_word_size, number_of_bits_added, tests_working_folder)
        load_all_shared_secret_alice_fast(zedboard, sidh_base_word_size, sidh_extended_word_size, number_of_bits_added, tests_working_folder)
        load_all_keygen_bob_fast(zedboard, sidh_base_word_size, sidh_extended_word_size, number_of_bits_added, tests_working_folder)
        load_all_shared_secret_bob_fast(zedboard, sidh_base_word_size, sidh_extended_word_size, number_of_bits_added, tests_working_folder)
    else:
        print('Program loading failed')

zedboard = Zedboard('COM5')
#zedboard.read_initial_message(34)
while(not zedboard.isFree()):
    time.sleep(0.01)
zedboard.flush()

test_all_sidh_functions(zedboard, 256)



#print('Is it Free? ' + str(zedboard.isFree()))
#prime = (2**(271))*3**(301)-1
#prime_list = integer_to_list(sidh_extended_word_size, 4, prime)
#zedboard.write_mac_ram_operand(sidh_core_mac_ram_input_function_start_address, prime_list, 4)
#read_value = zedboard.read_mac_ram_operand(sidh_core_mac_ram_input_function_start_address, 4)
#print(prime_list[0])
#print(read_value[0])
#print("-----------")
#print(prime_list[1])
