...
def test_single_eval_4_isog(arithmetic_parameters, fp2, test_value_x, test_value_xi, test_value_z, test_value_zi, test_value_k1, test_value_k1i, test_value_k2, test_value_k2i, test_value_k3, test_value_k3i):
    ...
    test_value_k3_mont   = enter_montgomery_domain(arithmetic_parameters, test_value_k3)
    test_value_k3i_mont  = enter_montgomery_domain(arithmetic_parameters, test_value_k3i)
    ...
    true_value_final = sage_eval_4_isog(fp2, test_value_x, test_value_xi, test_value_z, test_value_zi, test_value_k1, test_value_k1i, test_value_k2, test_value_k2i, test_value_k3, test_value_k3i)
    
    true_value_final_t1 = true_value_final[0:2]
    true_value_final_t5 = true_value_final[2:4]
    
    if((test_value_final_t1[0] != true_value_final_t1[0]) or (test_value_final_t1[1] != true_value_final_t1[1]) or (test_value_final_t5[0] != true_value_final_t5[0]) or (test_value_final_t5[1] != true_value_final_t5[1])):
        print("Error during the evaluate 4 isogenies procedure ")
        print('')
        print("Prime")
        print(prime)
        print('')
        ...
        print('')
        print("Test t5")
        print(test_value_final_t5)
        print('')
        print("True t5")
        print(true_value_final_t5)
        print('')
        return True
            
    return False
    
def test_eval_4_isog(base_word_size, extended_word_size, prime_size_bits, number_of_bits_added, accumulator_word_size, prime, number_of_tests):
                        ...
                        for test_value_k1i in maximum_tests:
                            for test_value_k2 in maximum_tests:
                                for test_value_k2i in maximum_tests:
                                    for test_value_k3 in maximum_tests:
                                        for test_value_k3i in maximum_tests:
                                            maximum_tests_input += [[test_value_x, test_value_xi, test_value_z, test_value_zi, test_value_k1, test_value_k1i, test_value_k2, test_value_k2i, test_value_k3, test_value_k3i]]
    ...
    for i in range(performed_tests):
        ...
        error_computation = test_single_eval_4_isog(arithmetic_parameters, fp2, test[0], test[1], test[2], test[3], test[4], test[5], test[6], test[7], test[8], test[9])
    ...
    if(not error_computation):
        for i in range(performed_tests, number_of_tests):
            ...
            test_value_k3  = randint(1, max_value-1)
            test_value_k3i = randint(1, max_value-1)
            
            error_computation = test_single_eval_4_isog(arithmetic_parameters, fp2, test_value_x, test_value_xi, test_value_z, test_value_zi, test_value_k1, test_value_k1i, test_value_k2, test_value_k2i, test_value_k3, test_value_k3i)
            if(error_computation):
                break
        
    return error_computation

def print_VHDL_eval_4_isog_test(VHDL_memory_file_name, base_word_size, extended_word_size, prime_size_bits, number_of_bits_added, accumulator_word_size, prime, number_of_tests):
    ...
    for test in maximum_tests_input:
        ...
        test_value_k3_list  = integer_to_list(extended_word_size_signed, number_of_words, test[8])
        test_value_k3i_list = integer_to_list(extended_word_size_signed, number_of_words, test[9])
        ...
        test_value_k3_mont   = enter_montgomery_domain(arithmetic_parameters, test[8])
        test_value_k3i_mont  = enter_montgomery_domain(arithmetic_parameters, test[9])
        ...
        print_list_convert_format_VHDL_MAC_memory(VHDL_memory_file, base_word_size_signed, base_word_size_signed_number_words, extended_word_size_signed, test_value_k3_list, maximum_number_of_words)
        print_list_convert_format_VHDL_MAC_memory(VHDL_memory_file, base_word_size_signed, base_word_size_signed_number_words, extended_word_size_signed, test_value_k3i_list, maximum_number_of_words)
    ...
    for i in range(tests_already_performed, number_of_tests):
        ...
        test_value_k3_list  = integer_to_list(extended_word_size_signed, number_of_words, test_value_k3)
        test_value_k3i_list = integer_to_list(extended_word_size_signed, number_of_words, test_value_k3i)
...
def load_VHDL_eval_4_isog_test(VHDL_memory_file_name, base_word_size, extended_word_size, prime_size_bits, number_of_bits_added, accumulator_word_size, prime, number_of_tests = 0, debug_mode=False):
    ...
    while(current_test != (number_of_tests-1)):
        ...
        test_value_k3         = load_list_value_VHDL_MAC_memory_as_integer(VHDL_memory_file, base_word_size_signed, base_word_size_signed_number_words, maximum_number_of_words, False)
        test_value_k3i        = load_list_value_VHDL_MAC_memory_as_integer(VHDL_memory_file, base_word_size_signed, base_word_size_signed_number_words, maximum_number_of_words, False)
...
def test_all_eval_4_isog(base_word_size_signed, extended_word_size_signed, number_of_bits_added, accumulator_word_size, primes, number_of_tests):
    error_computation = False
    for i in range(len(primes)):
        prime = primes[i]
        print("Testing prime : " + str(prime))
        prime_size_bits = int(prime).bit_length()
        error_computation = test_eval_4_isog(base_word_size_signed, extended_word_size_signed, prime_size_bits, number_of_bits_added, accumulator_word_size, prime, number_of_tests)
        if(error_computation):
            break
        
def print_all_VHDL_eval_4_isog_test(base_word_size_signed, extended_word_size_signed, number_of_bits_added, accumulator_word_size, primes, VHDL_file_names, number_of_tests):
    for i in range(len(primes)):
        prime = primes[i]
        VHDL_file_name = VHDL_file_names[i]
        print("Printing prime : " + str(prime))
        prime_size_bits = int(prime).bit_length()
        print_VHDL_eval_4_isog_test(VHDL_file_name, base_word_size_signed, extended_word_size_signed, prime_size_bits, number_of_bits_added, accumulator_word_size, prime, number_of_tests)

def load_all_VHDL_eval_4_isog_test(base_word_size_signed, extended_word_size_signed, number_of_bits_added, accumulator_word_size, primes, VHDL_file_names):
    for i in range(len(primes)):
        prime = primes[i]
        VHDL_file_name = VHDL_file_names[i]
        print("Loading prime test of : " + str(prime))
        prime_size_bits = int(prime).bit_length()
        load_VHDL_eval_4_isog_test(VHDL_file_name, base_word_size_signed, extended_word_size_signed, prime_size_bits, number_of_bits_added, accumulator_word_size, prime)
